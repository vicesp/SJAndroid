...
public class Cuajado_Realizados extends Activity implements AdapterView.OnItemClickListener,AdapterView.OnItemSelectedListener, OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cuajado__realizados);
        ...
        Regresa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                startActivity(new Intent(Cuajado_Realizados.this, Administrador.class));
            }
        });
    ...
    public void LLena_Lista(final ArrayList<consultas> ListaPaciente){
        ...
        for (final consultas con : ListaPaciente) {
            adapter = new ArrayAdapter<String>(this, R.layout.lista_item, R.id.tvItem, con.cuajado);
        }
        try {
