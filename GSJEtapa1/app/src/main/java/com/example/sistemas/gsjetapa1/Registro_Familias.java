...
public class Registro_Familias extends ActionBarActivity implements AdapterView.OnItemClickListener,AdapterView.OnItemSelectedListener, SearchView.OnQueryTextListener, View.OnClickListener 
    ...
    Guardar.setOnClickListener(new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (isEdit) {
                ...
                if (con.DAOActualizarFamilia(codigoFamilia.getText().toString().toUpperCase(), nombreFamilia.getText().toString(), 0)) {
                ...
                if (con.DAOGuardarFamilia(codigoFamilia.getText().toString(), nombreFamilia.getText().toString())) {
    ...
    Eliminar.setOnClickListener(new View.OnClickListener()
    {
        public void onClick(View v)
        {
            ...
            if (con.DAOActualizarFamilia(codigoFamilia.getText().toString(), nombreFamilia.getText().toString(), 1)) {
                Alerta(getResources().getString(R.string.Alerta_Actualizado));
                vaciarCampos();
    ...
    backButton.setOnClickListener(new View.OnClickListener()
    {
        public void onClick(View v)
        {
            finish();startActivity(new Intent(Registro_Familias.this, Administrador.class));
